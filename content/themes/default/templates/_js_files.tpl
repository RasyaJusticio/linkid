{strip}
  ...
  <script>
    ...
    var language_code = "{$system['language']['code']}";
    /* datetime */
  ...
  {if $user->_logged_in}
    ...
    <!-- Datatables -->
    {if in_array($page, ["admin", "ads", "wallet", "organization", "developers", "settings", "transfer"])}
  ...
  <!-- Slugify -->
  {if in_array($page, ["group", "groups", "organization", "organizations"])}
