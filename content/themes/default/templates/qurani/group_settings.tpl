<div class="card">
    <div class="card-header d-flex justify-content-between">
      <h4 class="card-title">{__('Settings')} › {__('Qurani')} (Grup)</h4>
      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
    <form class="js_ajax-forms" id="group-qurani-settings-form" data-url="groups/{$group['group_name']}/settings/qurani">
      <div class="card-body custom-scrollbar">
        ...
        <div id="bismillah-text" style="font-size: /* nanti di‑JS */; margin-left: 144px;">
          ...
          document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.error-labels input[type="checkbox"]').forEach(checkbox => {
              checkbox.addEventListener('change', function() {
                const settingId = this.dataset.settingId;
                const key = this.name; // Gunakan nama asli, misalnya error_sa-1
                if (settingId) {
                  // Hanya perbarui status untuk checkbox
              ...
              svg.addEventListener('click', function(e) {
                ...
                function commit() {
                  ...
                  if (newValue !== orig && settingId) {
                    // Perbarui value untuk edit nama
            ...
            resetBtn.addEventListener('click', async function(e) {
              ...
              Swal.fire({
                ...
                text: 'Semua pengaturan grup akan dikembalikan ke pengaturan global.',
                icon: 'warning',
            ...
            // Submit form handler
            const form = document.querySelector('#group-qurani-settings-form');
              ...
              Object.entries(pendingChanges).forEach(([settingId, data]) => {
                Object.entries(data).forEach(([key, value]) => {
                  if (typeof value === 'object') {
                    // Untuk checkbox (status) atau edit nama (value)
                    if ('status' in value) {
                    ...
                    // Untuk pengaturan lain (quran_layout, font_type, dll.)
