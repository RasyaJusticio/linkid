    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        <div class="stat-panel bg-gradient-info">
          <div class="stat-cell narrow">
            <i class="fa fa-dollar-sign bg-icon"></i>
            <span class="text-xxlg">{print_money($this_month_earnings|format_number)}</span><br>
            ...
            <tbody>
              {foreach $earnings as $earning}
                <tr>
                  ...
                  <td>{print_money($earning['price']|format_number)}</td>
                  <td>{print_money($earning['commission']|format_number)}</td>
                  <td>{print_money($earning['earning']|format_number)}</td>
                  <td>
